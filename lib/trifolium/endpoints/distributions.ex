defmodule Trifolium.Distributions do
  @moduledoc """
  ...
  @doc """
    Find a specific `Distribution` according to its `id` or `slug`.
  """
  ...
  @doc """
    Lists all available `Plant`s for a specific `Distribution` according to its `id` or `slug`.
  ...
  @doc """
    Lists all available `Specie`s for a specific `Distribution` according to its `id` or `slug`.
    You can paginate this endpoint, and also filter it, as explained on Trefle documentation.
    You can use a `filter` or a `not_filter` like so:
