defmodule Trifolium.Subkingdoms do
  @moduledoc """
    Module to be used to interact with Trefle [Subkingdoms](https://docs.trefle.io/reference/#tag/Subkingdoms) related endpoints.
  """

  alias Trifolium.Config
  alias Trifolium.API

  @endpoint_path "api/v1/subkingdoms/"
  @http_client Config.http_client()

  @doc """
    List every possible `Subkingom`s.
  ...
  @doc """
    Find a specific `Subkingdom` according to its `id` or `slug`.
  """
