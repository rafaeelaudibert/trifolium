defmodule Trifolium.Kingdoms do
  @moduledoc """
    Module to be used to interact with Trefle [Kingdoms](https://docs.trefle.io/reference/#tag/Kingdoms) related endpoints.
  """

  alias Trifolium.Config
  alias Trifolium.API

  @endpoint_path "api/v1/kingdoms/"
  @http_client Config.http_client()

  @doc """
    List every possible `Kingdom`s.
  ...
  @doc """
    Find a specific `Kingdom` according to its `id` or `slug`.
  """
